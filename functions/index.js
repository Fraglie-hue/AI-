...
export default {
  async fetch(request, env) {
    ...
    const apiKey = "sk-2f5a3573056240fcb5890310537d0c57";
    if (!apiKey||apiKey.includes("sk-2f5a3573056240fcb5890310537d0c57")){
       return json({ error: "Missing DASHSCOPE_API_KEY in env" }, 500);
    }
